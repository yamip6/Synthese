...
public class ConnectDB {    
    ...
    public static void main (String[] args) throws FileNotFoundException, IOException{  
        ...
        try{
            ...
            dbManipulate("INSERT INTO members (username, password) VALUES ('test', 'pass')");
            dbSelect("SELECT * FROM members WHERE username = 'test'");
            dbManipulate("UPDATE members SET password = 'passsecret' WHERE username = 'test'");
